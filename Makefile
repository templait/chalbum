#############################################################################
# Makefile for building: chalbum
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  chalbum.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile chalbum.pro
#############################################################################
...
CXX           = g++
DEFINES       = 
CFLAGS        = -pipe -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -O2 -fPIC $(DEFINES)
CXXFLAGS      = -pipe -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -O2 -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = chalbum1.0.0
DISTDIR = /home/chief/Projects/clouds/chalbum/chalbum/.tmp/chalbum1.0.0
LINK          = g++
...
SOURCES       = qml/main.qml \
		qml/Settings.qml \
		qml/MainWindow.qml \
		qml/ActionController.qml \
		qml/components/Style.qml \
...
Makefile: chalbum.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/default_post.prf \
		chalbum.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile chalbum.pro
...
main.o: qml/main.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o main.o qml/main.qml

Settings.o: qml/Settings.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o Settings.o qml/Settings.qml

MainWindow.o: qml/MainWindow.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o MainWindow.o qml/MainWindow.qml

ActionController.o: qml/ActionController.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o ActionController.o qml/ActionController.qml

Style.o: qml/components/Style.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o Style.o qml/components/Style.qml

LineEdit.o: qml/components/LineEdit.qml 
	$(CC) -c $(CFLAGS) $(INCPATH) -o LineEdit.o qml/components/LineEdit.qml
